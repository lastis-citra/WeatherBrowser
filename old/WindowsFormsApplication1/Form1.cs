...
namespace WeatherBrowser
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(date_array2[0]);
            MessageBox.Show(ul_vio_start_day);
        ...
        private void ChangeColorView1(int i)
        {
            ...
            // 最高気温の上値
            if (temp_array[i] != "---" && Properties.Settings.Default.bool_max_max_temp &&
            ...
            // 最低気温の下値
            if (temp_array[i] != "---" && Properties.Settings.Default.bool_min_min_temp &&
            ...
            // 湿度の上値
            if (wet_array[i] != "---" && (Regex.IsMatch(wet_array[i], @"^[0-9]+$")) &&
            ...
            // 降水量の上値
            if (rain_array[i] != "---" && Properties.Settings.Default.bool_max_rain &&
            ...
            // 降水量の下値
            if (rain_array[i] != "---" && Properties.Settings.Default.bool_min_rain &&
            ...
            // 風速の上値
            if (windst_array[i] != "---" && Properties.Settings.Default.bool_max_wind &&
            ...
            // 風速の下値
            if (windst_array[i] != "---" && Properties.Settings.Default.bool_min_wind &&

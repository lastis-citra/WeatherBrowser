...
namespace WeatherBrowser
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //string url7 = "http://bousai.tenki.jp/bousai/warn/point-708.html";
            //string url7 = "https://tenki.jp" + url_warn;
           ...
           // String[] st_warn2 = st_warn[3].Split('.');
            ...
            //string url8 = "https://tenki.jp/forecast/" + tmp_url_abst[5] + "/" + tmp_url_abst[6] + ".html";
            // v1.5からyahooに変更
            ...
            // 警報・注意報
            // v1.5からyahooに変更
            nodeList = doc7.GetNodesByTagName("ul");
            ...
            //foreach (HtmlNode node in nodeList)
            //{
            //    // 現在の警報・注意報はmap-warn-point-recent-entryの中にある
            //    if (node.Attributes.ContainsKey("class") && node.Attributes["class"] == "map-warn-point-recent-entry"){
            //        foreach (HtmlNode child in node.ChildNodes)
            //        {
            //            if (child.Attributes.Keys.Count == 0)
            //            {
            //                continue;
            //            }
            //            if (child.Attributes["class"] == "is-normal")
            //            {
            //                // 発表なしなら何もしない
            //                break;
            //            }
            //            if (child.Attributes["class"] == "is-special-warn")
            //            {
            //                string tmp_sp = child.InnerText.Replace("特別警報", "");
            //                special_array = ChangeStatusWarnNotice(tmp_sp, special_array);
            //            }
            //            if (child.Attributes["class"] == "is-warn")
            //            {
            //                string tmp_warn = child.InnerText.Replace("警報", "");
            //                warning_array = ChangeStatusWarnNotice(tmp_warn, warning_array);
            //            }
            //            if (child.Attributes["class"] == "is-alert")
            //            {
            //                string tmp_alert = child.InnerText.Replace("注意報", "");
            //                notice_array = ChangeStatusWarnNotice(tmp_alert, notice_array);
            //            }
            //        }
            //        break;
            ...
            //    //    && node.ParentNode.Attributes.ContainsKey("class") && node.ParentNode.Attributes["class"] == "map-warn-point-recent-entry")
            //    //{
            ...
            // v1.5からyahooに変更
            nodeList = doc7.GetNodesByAttribute("yjSt yjw_note_h2");

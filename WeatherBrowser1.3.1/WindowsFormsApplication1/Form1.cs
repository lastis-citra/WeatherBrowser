...
namespace WeatherBrowser
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string url7 = "http://tenki.jp" + url_warn;
            ...
            // ------------------------------------------------------
            //ダウンロードするURL（天気概況）
            string tmp8 = url_warn.Replace("warn", "forecast");
            string url8 = "http://tenki.jp" + tmp8;
            ...
            ////----------------------------------------------------------
            // 警報・注意報
            nodeList = doc7.GetNodesByTagName("td");
            bool check = false;
        ...
        {
            MessageBox.Show(this.listView2.SelectedIndices[0].ToString());
        }
    }
}
